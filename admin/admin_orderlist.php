        ...
        <div class="card-body">
            ...
            <table class="table table-bordered" id="productlist">
                ...
                <tbody>
                    <?php 
                    $i = 1;
                    $stmt = $conn->prepare("SELECT * FROM `order_list` ORDER BY `order_status` ASC, unix_timestamp(date_created) DESC");
                    $stmt->execute();
                    ...
                    <tr>
                        ...
                        <td class="px-2 py-1 align-middle text-center">
    <div class="dropdown">
        <button class="btn btn-flat border btn-light btn-sm dropdown-toggle dropdown-icon" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" <?php if ($role != 1) echo 'disabled'; ?>>
            Action
