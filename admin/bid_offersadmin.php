...
<head>
  ...
  <title>Admin | Bid Offers List</title>
...
if (mysqli_num_rows($bidQuery) > 0) {
  ...
  <div class="btn-group">
    ...
    <div class="dropdown-menu dropdown-menu-right" role="menu">
      <button class="dropdown-item accept-bid-btn" data-bid-id="<?= $bidId; ?>" data-harvest-schedule-id="<?= $harvestScheduleId; ?>" <?php if ($role != 1) echo 'disabled'; ?>>
