      ...
      <div class="container-fluid">
        ...
        <?php include('../php/message.php');?>
            ...
            <table id="productlist" class="table table-bordered">
                ...
                <tbody>
                    <?php
                        $query = "SELECT * FROM seller_accounts";
                        ...
                        if(mysqli_num_rows($query_run)>0){
                            foreach($query_run as $row){
                                ?>
                                    <tr>
                                        <td><?= $row['id']; ?></td>
                                        <td><img class="avatar-image mx-auto d-block" src="<?="../" . $row['shop_logo']; ?>"  alt="Profile Picture"  onclick="showFullImage(this)"></td>
                                        <td><?= $row['unique_id']; ?></td>
                                        <td><?= $row['shop_name']; ?></td>
                                        <td><?= $row['username']; ?></td>
                                        ...
                                        <td><?= $row['has_pstore']; ?></td>
                                        <td><img class="avatar-image mx-auto d-block" src="<?="../" . $row['valid_id']; ?>"  alt="Valid ID"  onclick="showFullImage(this)"></td>
                                        <td><img class="avatar-image mx-auto d-block" src="<?="../" . $row['business_permit']; ?>"  alt="Business Permit"  onclick="showFullImage(this)"></td>
                                        <td><img class="avatar-image mx-auto d-block" src="<?="../" . $row['mayors_permit']; ?>"  alt="Mayor's Permit"  onclick="showFullImage(this)"></td>
                                        <td><img class="avatar-image mx-auto d-block" src="<?="../" . $row['dti_permit']; ?>"  alt="D.T.I Permit"  onclick="showFullImage(this)"></td>
                                  ...
                                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item keychainify-checked" href="../admin/edit-seller.php?id=<?= $row['id'];?>"><span class="fa fa-edit text-primary"></span> Edit</a>
				                    <div class="dropdown-divider"></div>

                                    <form action="../php/deleteselleradmin.php" method="POST">
                                                            <button type="submit" name="seller_delete" value="<?= $row['id']; ?>"
