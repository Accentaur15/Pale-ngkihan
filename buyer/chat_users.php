...
<script>
    ...
    usersList.addEventListener("click", (event) => {
        ...
        if (event.target.tagName === "A") {
            ...
            // Extract the seller_id from the link's data attribute
            let sellerId = event.target.getAttribute("data-seller-id");
            // Navigate to the chat page with the selected seller
            window.location.href = "chat.php?user_id=" + sellerId;
        }
    });
