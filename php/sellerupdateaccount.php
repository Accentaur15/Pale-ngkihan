...
$sql = mysqli_query($conn, "SELECT email, password, shop_logo, valid_id, dti_permit, business_permit, mayors_permit FROM seller_accounts WHERE unique_id = '{$unique_id}'");
    ...
    if($oldpassword == $currentPassword){
       ...
       // echo "Using print_r():\n";
        //print_r($validIdFile);
            ...
            // Update query
            $updateQuery = "UPDATE seller_accounts SET username = '{$username}', shop_name = '{$shopname}', shop_owner = '{$shopowner}', gender = '{$gender}', contact = '{$cnumber}', address = '{$address}', email = '{$email}', has_pstore = '{$ispstore}'  WHERE unique_id = '{$unique_id}'";
